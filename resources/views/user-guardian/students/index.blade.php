                            ...
                            @foreach($data['students'] as $student)
                                    ...
                                    <div class="col-xs-12 col-sm-9">
                                        ...
                                        <div class="profile-user-info profile-user-info-striped">
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-name"> Semester/Class :</div>
                                                <div class="profile-info-value">
                                ...
                                <div class="clearfix hidden-print ">
                                    <div class="easy-link-menu align-left">
                                        ...
                                        <a class="{!! request()->is('user-guardian/students/routine')?'btn-success':'btn-primary' !!} btn-sm" href="{{ route('user-guardian.students.routine',['id'=>Crypt::encryptString($student->id)]) }}"><i class="fa fa-calendar-check-o" aria-hidden="true"></i> Class Routine</a>
                                    </div>
                                </div>
                               <hr class="hr-32">
                            @endforeach
