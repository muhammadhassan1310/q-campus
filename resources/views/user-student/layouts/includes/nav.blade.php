<div id="navbar" class="navbar navbar-default    navbar-collapse       h-navbar ace-save-state">
    <div class="navbar-container ace-save-state" id="navbar-container">
        <div class="navbar-header pull-left" style="width: 600px;">
            <a href="{{ route('user-student') }}" class="navbar-brand" style="width: 500px;">
                <small class="text-capitalize">
                    <img src="http://localhost:8000/assets/images/CMS-Icon.png" class="img-responsive" style="width: 10%;display: inherit;">
