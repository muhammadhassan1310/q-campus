...
<div class="form-group">
    ...
    <div class="col-sm-4">
        {!! Form::password('confirmPassword',  ["placeholder" => "", "class" => "form-control border-form"/*,"onkeyup"=>"passCheck()"*/,"id"=>"repatpass"]) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        {!! Form::text('contact_number', null, ["placeholder" => "", "class" => "form-control border-form","autofocus"]) !!}
